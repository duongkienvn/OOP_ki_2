...
public class TestMyList {
    public static void main(String[] args) {
        ...
        String filePath = "C:\\Users\\Dell\\eclipse-workspace\\" +
                "OOP_ki_2\\src\\hus\\oop\\examination\\students\\DuongCongKien-23001895-MyList.txt";
        saveToFile(filePath);
    }
    ...
    public static void testMyArrayList(PrintWriter printWriter) {
        /*
         TODO
        ...
        printWriter.println("sorting by increasing name");
        printWriter.println(increasingByName);
        printWriter.println("sorting by decreasing name");
        printWriter.println(decreasingByName);
        printWriter.println("sorting by increasing average");
        printWriter.println(increasingByAverage);
        printWriter.println("sorting by decreasing average");
        printWriter.println(decreasingByAverage);
    }
    ...
    public static void testMyLinkedList(PrintWriter printWriter) {
        /*
         TODO
    ...
    public static void testIterator(MyList myList, PrintWriter printWriter) {
        /*
         TODO
         Sử dụng iterator duyệt qua tất cả các phần tử trong danh sách myList và in ra thông tin về phần tử đó.
         */
    ...
    public static void saveToFile(String filePath) {
        try (PrintWriter printWriter = new PrintWriter(new FileWriter(filePath))) {
            printWriter.write("testMyArrayList:\n");
            testMyArrayList(printWriter);
            printWriter.write("testMyLinkedList:\n");
            testMyLinkedList(printWriter);
            MyList myList = createMyList();
            testIterator(myList, printWriter);
        } catch (IOException e) {
